#!/usr/bin/env python3
"""MoGe-2 metric depth for a structure study's views, scaled into the capture's SfM
...
modelled garage opening, not from a measurement).
  ...
  condo-moge-depth.py --structure data/spatial/condo-capture-structure-2026-09-09-02 --output data/spatial/condo-moge-depth-<date>-01
"""
