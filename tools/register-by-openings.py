...
along the wall are relative to the door, the stucco face is placed ON the framing line.
  ...
  register-by-openings.py --scaffold DIR --moge DIR --building building.json --wall <model wall id> \\
      --patch <capture wall patch> --door <model opening id> [--anchor door|window-pair] --output DIR/registration.json
"""
